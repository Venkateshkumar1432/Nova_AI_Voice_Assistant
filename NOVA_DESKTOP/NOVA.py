...
from NovaUi import Ui_JarvisUI
...
class DataStore:
    ...
    def get_user_input(self):
        input_value = DataStore.user_input  # Clear the input after retrieving it
        return input_value
...
class MainThread(QThread):
    ...
    def run_jarvis(self):
        self.wish()
        self.talk('Hello boss I am nova your assistant. please tell me how can i help you')
        while True:
            ...
            #command if you don't want the nova to spack until for a certain time
            #Note: I can be silent for max of 10mins
            # Eg: nova keep quiet for 5 minutes 
            ...
            #Eg : nova open facebook (or) nova open social media facebook 
            ...
            #Eg: nova open a profile on instagram 
            ...
            #Eg: nova check covid (or) corona status
            ...
            #group => Eg: send a message to school group NOTE: mention the name "group" otherwise nova cannot detect the name
    ...
    def SendEmail(self,to,content):
        ...
        server.ehlo()
        server.starttls()
        server.login("project1geekbytes@gmail.com","tqotksbcdcoziump")
        server.sendmail("project1geekbytes@gmail.com",to,content)
        server.close()
