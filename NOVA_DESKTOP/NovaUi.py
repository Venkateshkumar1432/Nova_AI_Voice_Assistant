...
class Ui_JarvisUI(object):
    ...
    def setupUi(self, JarvisUI):
        ...
        JarvisUI.showFullScreen()  # Make it full screen

        self.centralwidget = QtWidgets.QWidget(JarvisUI)
        self.centralwidget.setObjectName("centralwidget")

        self.label = QtWidgets.QLabel(self.centralwidget)
        self.label.setGeometry(QtCore.QRect(0, 0, 1920, 1280))
        ...
        self.inputTextBox.setGeometry(QtCore.QRect(600, 950, 600, 50))
        self.inputTextBox.setStyleSheet("font-size: 20px; color: black; background-color: white; border-radius: 5px;")
        self.inputTextBox.setPlaceholderText("Type your command here...")
        self.inputTextBox.setObjectName("inputTextBox")

        # Submit button
        self.submitButton = QtWidgets.QPushButton(self.centralwidget)
        self.submitButton.setGeometry(QtCore.QRect(1220, 950, 121, 50))
        font = QtGui.QFont()
        font.setPointSize(16)
        font.setBold(True)
        self.submitButton.setFont(font)
        self.submitButton.setStyleSheet("background-color: rgb(0, 136, 255); color: white;")
        ...
        # Update the NOVA label to display the text
        self.label_3 = QtWidgets.QLabel(self.centralwidget)
        self.label_3.setGeometry(QtCore.QRect(580, 360, 661, 381))
        self.label_3.setText("NOVA")
        self.label_3.setAlignment(QtCore.Qt.AlignCenter)
        self.label_3.setStyleSheet("font-size: 60px; color: white; font-weight: bold;")
    ...
    def update_recognition_text(self, command):
        self.textBrowser.setText(command)
